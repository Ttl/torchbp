...
TORCH_LIBRARY(torchbp, m) {
  ...
  m.def("ffbp_merge2_lanczos(Tensor img0, Tensor img1, Tensor dorigin, float fc, Tensor r0, Tensor dr0, Tensor theta0, Tensor dtheta0, Tensor Nr0, Tensor Ntheta0, float r1, float dr1, float theta1, float dtheta1, int Nr1, int Ntheta1, float z1, int order, Tensor att, Tensor g, float g_az0, float g_el0, float g_daz, float g_del, int g_naz, int g_nel) -> Tensor");
